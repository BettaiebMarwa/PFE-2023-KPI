    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" style={{width: '90%'}}>
          ...
          <li class="nav-item">
            <a class="nav-link" href="/Equipes">Ajout Equipe</a>
          </li>
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/Developpeur">Ajout</a></li>
            <li><a class="dropdown-item" href="/Developpeur/Afficher">Modifier/Supprimer</a></li>
          </ul>
        </li>
          <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <li class="nav-item">
            <a class="nav-link" href='/utilisateur'>Ajout Utilisateurs</a>
          </li>
          <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Gestion Tickets
