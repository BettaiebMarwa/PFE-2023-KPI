  ...
  <div class="modal-dialog">
    <div class="modal-content" style={{width:'800px'}}>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-secondary" onClick={ViderHistorique} >Vider Historique</button>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" style={{width: '90%'}}>
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/Equipes">Ajout</a></li>
            <li><a class="dropdown-item" href="/Equipe/Afficher">Modifier/Supprimer</a></li>
          </ul>
        </li>
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/utilisateur">Ajout</a></li>
            <li><a class="dropdown-item" href="/utilisateur/Afficher">Modifier/Supprimer</a></li>
          </ul>
  </li>*/}
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/Ticket/Ajout">Ajout</a></li>
            <li><a class="dropdown-item" href="/Ticket/Afficher">Modifier/Supprimer</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/Clients">Ajout</a></li>
            <li><a class="dropdown-item" href="/Clients/Afficher">Modifier/Supprimer</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
         ...
         Chefs de projet
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/ChefProjet/Ajout">Ajout</a></li>
            <li><a class="dropdown-item" href="/ChefProjet/Afficher">Modifier/Supprimer</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" href="/Horaire/Afficher">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0" style={{float: 'right',position:'relative',right:'50px'}} >
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" >
                  ...
                  <li><a class="dropdown-item" href="#" onClick={ViderHistorique}>Vider Historique</a></li>
